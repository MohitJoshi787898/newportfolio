  ...
  const socialLinks = [
    {
      icon: Github,
      label: "GitHub",
      href: "https://github.com/mohitjoshi155",
      color: "hover:text-gray-400",
    },
    {
      icon: Linkedin,
      label: "LinkedIn",
      href: "https://linkedin.com/in/mohit-joshi-dev",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto">
            Let's connect and explore how we can create something meaningful together. Whether it's a project
            collaboration or just a conversation about technology and philosophy.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-2xl text-orange-400">Send a Message</CardTitle>
              </CardHeader>
              <CardContent>
          ...
          >
            <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-2xl text-amber-400">Get in Touch</CardTitle>
              </CardHeader>
            ...
            <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="text-2xl text-amber-400">Connect Online</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            >
              <h3 className="text-xl font-bold text-orange-400 mb-4">Available for Opportunities</h3>
              <p className="text-slate-300 mb-6">
                I'm currently open to full-time positions, freelance projects, and interesting collaborations. Let's
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  ...
                  onClick={() => window.open("/resume-mohit-joshi.pdf", "_blank")}
                >
                ...
                <Button
                  ...
                  onClick={() => window.open("https://calendly.com/mohitjoshi-dev/30min", "_blank")}
                >
